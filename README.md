...
- **Кошелёк** — экран в стиле TonKeeper поверх локального баланса TON: два локальных
  кошелька, «Отправить»/«Получить» между ними, свой адрес и история. Полностью локально,
  адреса не могут принять настоящие TON.
